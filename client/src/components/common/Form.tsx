      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        <form style={{
          ...
          <FormControl>
            <FormHelperText sx={{
              fontWeight: 500, margin: '10px 0', fontSize: 16, color: '#11142d'
            }}>Enter Discription</FormHelperText>
            <TextareaAutosize minRows={5} required placeholder="Write discription" color="info" style={{
              width: '100%',
          ...
          <Stack direction="row" gap={4}>
            <FormControl sx={{ flex: 1}}>
              ...
              <Select variant="outlined" color="info" displayEmpty required inputProps={{ 'aria-label': 'Without label'}} defaultValue="apartment" {...register('propertyType', { required: true})} >
                ...
                <MenuItem value="farmhouse">Formhouse</MenuItem>
