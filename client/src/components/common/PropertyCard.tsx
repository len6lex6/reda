...
const PropertyCard = ({ id, title, location, price, photo}: PropertyCardProps) => {
  return (
    ...
    >
      ...
      <CardContent sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', gap: '10px', paddigX: '5px' }}>
        ...
        <Box px={1.5} borderRadius={1} bgcolor="#dadefa" height="fit-content">
