    ...
    <Box>
      ...
      <Box mt="20px" sx={{ display: 'flex', flexWrap: 'wrap', gap: 3}}>
        ...
        <Box mb={2} display="flex" width="84%" justifyContent="space-between" flexWrap="wrap">
          <Box display="flex" gap={3} flexWrap="wrap" mb={{ xs: '20px', sm: 0}}>
            ...
            <Select variant='outlined' color='info' displayEmpty required inputProps={{ 'arial-label' : 'Without label'}} defaultValue="" 
      ...
      {allProperties.length > 0 && (
        <Box display="flex" gap={2} mt={3} flexWrap="wrap" >
          ...
          <Box display={{xs: 'hidden', sm: 'fles' }} alignItems="center" gap="5px" >
          ...
          <Select variant='outlined' color='info' displayEmpty required inputProps={{ 'arial-label' : 'Without label'}} defaultValue={10} 
